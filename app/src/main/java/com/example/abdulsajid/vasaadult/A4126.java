...
public class A4126 extends AppCompatActivity {
    ...
    private void SaveDraft() {
        ...
        A4126_A4140.A4128 = bind.A4128a.isChecked() ? "1"
                : bind.A4128b.isChecked() ? "2"
                : bind.A412898.isChecked() ? "98"
                : bind.A412899.isChecked() ? "99"
                : "0";

        A4126_A4140.A4129 = bind.A4129a.isChecked() ? "1"
                : bind.A4129b.isChecked() ? "2"
                : bind.A412998.isChecked() ? "98"
                : bind.A412999.isChecked() ? "99"
                : "0";

        A4126_A4140.A4130u = bind.A4130ua.isChecked() ? "1"
                : bind.A4130ub.isChecked() ? "2"
                : bind.A4130u98.isChecked() ? "98"
                : bind.A4130u99.isChecked() ? "99"
                : "0";

        A4126_A4140.A4130D = bind.A4130D.getText().toString().trim().length() > 0 ? bind.A4130D.getText().toString() : "0";
        A4126_A4140.A4130M = bind.A4130M.getText().toString().trim().length() > 0 ? bind.A4130M.getText().toString() : "0";

        A4126_A4140.A4131 = bind.A4131a.isChecked() ? "1"
                : bind.A4131b.isChecked() ? "2"
                : bind.A413198.isChecked() ? "98"
                : bind.A413199.isChecked() ? "99"
                : "0";

        A4126_A4140.A4132 = bind.A4132a.isChecked() ? "1"
                : bind.A4132b.isChecked() ? "2"
                : bind.A413298.isChecked() ? "98"
                : bind.A413299.isChecked() ? "99"
                : "0";

        A4126_A4140.A4133 = bind.A4133a.isChecked() ? "1"
                : bind.A4133b.isChecked() ? "2"
                : bind.A413398.isChecked() ? "98"
                : bind.A413399.isChecked() ? "99"
                : "0";

        A4126_A4140.A4134u = bind.A4134ua.isChecked() ? "1"
                : bind.A4134ub.isChecked() ? "2"
                : bind.A4134u98.isChecked() ? "98"
                : bind.A4134u99.isChecked() ? "99"
                : "0";

        A4126_A4140.A4134D = bind.A4134D.getText().toString().trim().length() > 0 ? bind.A4134D.getText().toString() : "0";
        A4126_A4140.A4134M = bind.A4134M.getText().toString().trim().length() > 0 ? bind.A4134M.getText().toString() : "0";

        A4126_A4140.A4135 = bind.A4135a.isChecked() ? "1"
                : bind.A4135b.isChecked() ? "2"
                : bind.A413598.isChecked() ? "98"
                : bind.A413599.isChecked() ? "99"
                : "0";

        A4126_A4140.A4136 = bind.A4136a.isChecked() ? "1"
                : bind.A4136b.isChecked() ? "2"
                : bind.A413698.isChecked() ? "98"
                : bind.A413699.isChecked() ? "99"
                : "0";

        A4126_A4140.A4137 = bind.A4137a.isChecked() ? "1"
                : bind.A4137b.isChecked() ? "2"
                : bind.A413798.isChecked() ? "98"
                : bind.A413799.isChecked() ? "99"
                : "0";

        A4126_A4140.A4138 = bind.A4138a.isChecked() ? "1"
                : bind.A4138b.isChecked() ? "2"
                : bind.A413898.isChecked() ? "98"
                : bind.A413899.isChecked() ? "99"
                : "0";

        A4126_A4140.A4139 = bind.A4139a.isChecked() ? "1"
                : bind.A4139b.isChecked() ? "2"
                : bind.A413998.isChecked() ? "98"
                : bind.A413999.isChecked() ? "99"
                : "0";

        A4126_A4140.A4140 = bind.A4140a.isChecked() ? "1"
