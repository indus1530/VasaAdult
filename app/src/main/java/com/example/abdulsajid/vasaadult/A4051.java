...
public class A4051 extends AppCompatActivity {
    ...
    private void SaveDraft() {
        ...
        A4051_A4066.A4051 = bind.A4051a.isChecked() ? "1"
                : bind.A4051b.isChecked() ? "2"
                : bind.A405198.isChecked() ? "98"
                : bind.A405199.isChecked() ? "99"
                : "0";

        A4051_A4066.A4052u = bind.A4052ua.isChecked() ? "1"
                : bind.A4052ub.isChecked() ? "2"
                : bind.A4052u98.isChecked() ? "98"
                : bind.A4052u99.isChecked() ? "99"
                : "0";

        A4051_A4066.A4052D = bind.A4052D.getText().toString().trim().length() > 0 ? bind.A4052D.getText().toString() : "0";

        A4051_A4066.A4052M = bind.A4052M.getText().toString().trim().length() > 0 ? bind.A4052M.getText().toString() : "0";

        A4051_A4066.A4053 = bind.A4053a.isChecked() ? "1"
                : bind.A4053b.isChecked() ? "2"
                : bind.A405398.isChecked() ? "98"
                : bind.A405399.isChecked() ? "99"
                : "0";

        A4051_A4066.A4054 = bind.A4054a.isChecked() ? "1"
        ...
        A4051_A4066.A4055 = bind.A4055a.isChecked() ? "1"
        ...
        A4051_A4066.A4056 = bind.A4056a.isChecked() ? "1"
        ...
        A4051_A4066.A4057 = bind.A4057a.isChecked() ? "1"
        ...
        A4051_A4066.A4058 = bind.A4058a.isChecked() ? "1"
        ...
        A4051_A4066.A4059u = bind.A4059ua.isChecked() ? "1"
                : bind.A4059ub.isChecked() ? "2"
                : bind.A4059u98.isChecked() ? "98"
                : bind.A4059u99.isChecked() ? "99"
                : "0";

        A4051_A4066.A4059D = bind.A4059D.getText().toString().trim().length() > 0 ? bind.A4059D.getText().toString() : "0";

        A4051_A4066.A4059M = bind.A4059M.getText().toString().trim().length() > 0 ? bind.A4059M.getText().toString() : "0";


        A4051_A4066.A4060 = bind.A4060a.isChecked() ? "1"
        ...
        A4051_A4066.A4061 = bind.A4061a.isChecked() ? "1"
        ...
        A4051_A4066.A4062 = bind.A4062a.isChecked() ? "1"
        ...
        A4051_A4066.A4063 = bind.A4063a.isChecked() ? "1"
        ...
        A4051_A4066.A4064u = bind.A4064ua.isChecked() ? "1"
                : bind.A4064ub.isChecked() ? "2"
                : bind.A4064u98.isChecked() ? "98"
                : bind.A4064u99.isChecked() ? "99"
                : "0";

        A4051_A4066.A4064D = bind.A4064D.getText().toString().trim().length() > 0 ? bind.A4064D.getText().toString() : "0";

        A4051_A4066.A4064M = bind.A4064M.getText().toString().trim().length() > 0 ? bind.A4064M.getText().toString() : "0";


        A4051_A4066.A40641 = bind.A40641a.isChecked() ? "1"
        ...
        A4051_A4066.A4065 = bind.A4065a.isChecked() ? "1"
        ...
        A4051_A4066.A4066 = bind.A4066a.isChecked() ? "1"
    ...
    boolean validateField() {
        return Gothrough.IamHiden(bind.llA4051);
    }
}
