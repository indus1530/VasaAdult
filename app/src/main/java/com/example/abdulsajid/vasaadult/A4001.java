...
public class A4001 extends AppCompatActivity {
    ...
    private void SaveDraft() {
        ...
        A4001_A4014.A4003 = bind.A4003a.isChecked() ? "1"
                : bind.A4003b.isChecked() ? "2"
                : bind.A400398.isChecked() ? "98"
                : bind.A400399.isChecked() ? "99"
                : "0";

        A4001_A4014.A4004 = bind.A4004a.isChecked() ? "1"
        ...
        A4001_A4014.A4005 = bind.A4005.getText().toString().trim().length() > 0 ? bind.A4005.getText().toString() : "0";

        A4001_A4014.A4006 = bind.A4006a.isChecked() ? "1"
                : bind.A4006b.isChecked() ? "2"
                : bind.A400698.isChecked() ? "98"
                : bind.A400699.isChecked() ? "99"
                : "0";

        A4001_A4014.A4007 = bind.A4007a.isChecked() ? "1"
        ...
        A4001_A4014.A40071 = bind.A40071.getText().toString().trim().length() > 0 ? bind.A40071.getText().toString() : "0";

        A4001_A4014.A4008 = bind.A4008a.isChecked() ? "1"
                : bind.A4008b.isChecked() ? "2"
                : bind.A400898.isChecked() ? "98"
                : bind.A400899.isChecked() ? "99"
                : "0";

        A4001_A4014.A4009a = bind.A4009aa.isChecked() ? "1"
                : bind.A4009ab.isChecked() ? "2"
                : bind.A4009a98.isChecked() ? "98"
                : bind.A4009a99.isChecked() ? "99"
                : "0";

        A4001_A4014.A4010 = bind.A4010a.isChecked() ? "1"
        ...
        A4001_A4014.A4011 = bind.A4011.getText().toString().trim().length() > 0 ? bind.A4011.getText().toString() : "0";

        A4001_A4014.A4012 = bind.A4012.getText().toString().trim().length() > 0 ? bind.A4012.getText().toString() : "0";

        A4001_A4014.A4013u = bind.A4013ua.isChecked() ? "1"
        ...
        A4001_A4014.A4013d = bind.A4013d.getText().toString().trim().length() > 0 ? bind.A4013d.getText().toString() : "0";

        A4001_A4014.A4013m = bind.A4013m.getText().toString().trim().length() > 0 ? bind.A4013m.getText().toString() : "0";

        A4001_A4014.A4013y = bind.A4013y.getText().toString().trim().length() > 0 ? bind.A4013y.getText().toString() : "0";

        A4001_A4014.A4014 = bind.A4014a.isChecked() ? "1"
    ...
    boolean validateField() {
        return Gothrough.IamHiden(bind.llA4001);
    }
